...
<div className="bg-saffron/10 p-2.5 rounded-full"><span className="material-symbols-outlined text-saffron">medical_services</span></div>
...
<p className="text-xs text-gray-500 dark:text-gray-400">Note: High severity may trigger an alert to your care team.</p>
</div>
</div>
);
};
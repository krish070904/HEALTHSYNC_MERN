...
<div className="bg-saffron/10 p-2.5 rounded-full"><span className="material-symbols-outlined text-saffron">monitor_heart</span></div>
...
/>
<span className="absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400 dark:text-gray-500">mg/dL</span>
</div>
</div>
...
placeholder="SYS/DIA"
/>
<span className="absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400 dark:text-gray-500">SYS/DIA</span>
</div>
</div>
...
/>
<span className="absolute inset-y-0 right-0 flex items-center pr-3 text-sm text-gray-400 dark:text-gray-500">kg</span>
</div>
</div>
</div>
</div>
